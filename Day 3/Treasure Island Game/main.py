...
option_one = input(
    'Do you accept his offer? Answer by typing "y" for yes or "n" for no:\n'
).casefold()
...
if option_one == "y":
    ...
    if option_two == "y":
        ...
        option_three = input(
            'Do you choose the "small", "medium" or "large" lens:\n'
        ).casefold()
        ...
        if option_three == "small":
            ...
            option_four = input(
                "Do you give him the orb not knowing what it does? y/n:\n"
            )
        ...
        print(
            "You look at the mountain and decide that you don't want to exert that much energy. Game Over. (You didn't answer y/n)"
        )
    ...
    print(add_sep + "You pass over his offer and move on with your life. Game Over.")
