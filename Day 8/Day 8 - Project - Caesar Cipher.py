...
while cipher_running:
    ...
    keep_running = input("Would you like to continue using the Caesar Cipher?\nType yes or no: ").casefold()
    no_answer    = True
    ...
    while no_answer:
        if keep_running in ("no", "n"):
            ...
            keep_running = input("Invalid answer, please only type in \"yes\" or \"no\".\nType yes or no: ")