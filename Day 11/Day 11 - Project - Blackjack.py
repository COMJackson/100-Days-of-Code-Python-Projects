...
def starting_print(show_stages, show_card_values, p_hand=None, d_hand=None, show_dealers_second_card=None):
    """
    ...
    if clear_terminal: os.system("cls")
    print(art.logo)
    ...
    if (p_hand and d_hand and show_dealers_second_card) != None:
        ...
        if show_dealers_second_card:
            ...
            print(f"Dealer's hand is showing {d_hand[0][0]} points. Their other card is flipped down.")
...
def blackjack(player_bet):
    ...
    # Round flags.
    round_active = True # Used as flag for while loop, when set to False is the last run.
    round_ending = False # Used to allow for one more FULL run of the while loop to run.
    ...
    # Dealer flags.
    show_dealers_second_card = False # Used to toggle visablity of the dealers second card.
    ...
    while round_active:
        ...
        starting_print(show_stages=False, show_card_values=True, p_hand=player_hand, 
                       d_hand=dealer_hand, show_dealers_second_card=show_dealers_second_card)
        ...
        if round_ending:
            ...
            if player_won == True:
                ...
                player_gain_loss += -(player_bet)
                print("You lost this round. Your bet is given to the dealer, better luck next round.")
            else:
                player_gain_loss = 0
        ...
        if player_hand_value < 21 and not player_done:
            ...
            if player_action == "hit": 
                ...
                print("The command you enter was invalid, please only enter \"hit\" or \"pass\".")
                input("Hit enter to continue.")
...
def start_game(passed_game_num=None, passed_player_bank=None):
    ...
    # will ask for the user to add funds to the bank account.
        ...
        player_bank = verify_int_input("You have no money in your bank!\nHow much money are adding to your bank?: $")
    ...
    new_game = input("Do you wish to keep playing or close the application, hit enter to continue playing or type \"close\" or \"c\" to close.\n").casefold
